...
- `src/FunLang/IndentFilter.fs` - TYPECLASS/INSTANCE set JustSawModule=true in both filter variants
- `src/FunLang/Parser.fsy` - TypeClassMethod grammar changed to PIPE IDENT COLON TypeExpr
