...
**Delivered:** FunLangCompiler Prelude 호환 빌트인 8개 (hashtable_*_str 7개 + dbg)
- 9 files changed, +439 LOC in v11.1
- 713 flt tests, 244 unit tests
- 83 phases, 169+ plans executed across v1.0-v11.1
