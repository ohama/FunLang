...
decisions:
  ...
  - id: "06-04-02"
    decision: "Re-raise FunLangException when no handler matches in try-with"
...
- **Fix:** Wrapped evalMatchClauses call in try-with that catches the match failure and re-raises the original FunLangException
